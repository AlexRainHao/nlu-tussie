...
from nlu_tussie.utils import lazyproperty, write_to_file
from nlu_tussie.utils import list_to_str
from nlu_tussie.training_data.util import check_duplicate_synonym
...
class TrainingData(object):
    ...
    def as_json(self, **kwargs):
        ...
        from nlu_tussie.training_data.formats import RasaWriter
        return RasaWriter().dumps(self)

    def as_markdown(self):
        # type: () -> str
        """Generates the markdown representation of the TrainingData."""
        from nlu_tussie.training_data.formats import MarkdownWriter

...
# LIBPATH = opt.abspath(opt.join(opt.abspath(__file__), *[opt.pardir] * 3))
...
parser.add_argument('--clip_resume', action = "store_true")
...
if args.clip_resume:
    ...
    create_cliped_file("{}/train.char.bmes".format(resume_ner_path))
    create_cliped_file("{}/dev.char.bmes".format(resume_ner_path))
    create_cliped_file("{}/test.char.bmes".format(resume_ner_path))

...
import nlu_tussie
from nlu_tussie import components, utils, config
from nlu_tussie.components import Component, ComponentBuilder
from nlu_tussie.config import RasaNLUModelConfig, override_defaults
from nlu_tussie.persistor import Persistor
from nlu_tussie.training_data import TrainingData, Message
from nlu_tussie.utils import create_dir, write_json_to_file
...
class Metadata(object):
    ...
    def persist(self, model_dir):
        ...
        metadata.update({
            ...
            "rasa_nlu_version": nlu_tussie.__version__,
        })
    ...
    def ensure_model_compatibility(metadata, version_to_check=None):
        ...
        if version.parse(model_version) < version.parse(version_to_check):
            raise UnsupportedModelError(
                ...
                "".format(model_version, nlu_tussie.__version__))

...
# ====================
# tokenizer
from ner_tussie.utils.spacy_utils import SpacyNLP
from ner_tussie.tokenizers.spacy_tokenizer import SpacyTokenizer
from ner_tussie.tokenizers.jieba_tokenizer import JiebaTokenizer
from ner_tussie.tokenizers.lac_tokenizer import LacTokenizer

# ====================
# features
from ner_tussie.featurizers.intent_featurizer_wordvector import WordVectorsFeaturizer  # customize
from ner_tussie.featurizers.bert_vectors_featurizer import BertVectorsFeaturizer  # customize
from ner_tussie.featurizers.ngram_featurizer import NGramFeaturizer
from ner_tussie.featurizers.regex_featurizer import RegexFeaturizer
from ner_tussie.featurizers.count_vectors_featurizer import CountVectorsFeaturizer

# ====================
# extractors
from ner_tussie.extractors.entity_synonyms import EntitySynonymMapper
from ner_tussie.extractors.crf_entity_extractor import CRFEntityExtractor
from ner_tussie.extractors.bilstm_crf_extractor import BiLSTMCrfEntityExtractor # customize
from ner_tussie.extractors.jieba_pseg_extractor import JiebaPsegExtractor  # customize
from ner_tussie.extractors.spacy_ner_extractor import SpacyEntityExtractor # customize
from ner_tussie.extractors.lac_ner_extractor import LacEntityExtractor # customize
from ner_tussie.extractors.lattice_extractor import LatticeNerEntityExtractor # customize

from ner_tussie.extractors.nerMoney import MoneyExtractor # customize
from ner_tussie.extractors.nerNumber import NumberPatternExtractor # customize
from ner_tussie.extractors.nerIdentity import IdentityPatternExtractor # customize
from ner_tussie.extractors.nerLawAbout import LawAboutExtractor # customize

# ====================
# classifier
from ner_tussie.classifiers.albert_classifier import AlbertIntentClassifier
from ner_tussie.classifiers.bert_classifier import BertIntentClassifier
from ner_tussie.classifiers.keyword_classifier import KeyWordIntentClassifier
from ner_tussie.classifiers.svm_classifier import SklearnIntentClassifier
from ner_tussie.classifiers.embedding_classifier import StarSpaceEmbeddingClassifier

if typing.TYPE_CHECKING:
    from ner_tussie.components import Component
    from ner_tussie.config import RasaNLUModelConfig, RasaNLUModelConfig
    ...
    if component_name not in registered_components:
        try:
            ...
            raise Exception(
                    ...
                    "`ner_tussie.registry.py` or is a proper name of a class "

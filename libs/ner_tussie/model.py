...
import ner_tussie
from ner_tussie import components, utils, config
from ner_tussie.components import Component, ComponentBuilder
from ner_tussie.config import RasaNLUModelConfig, override_defaults
from ner_tussie.persistor import Persistor
from ner_tussie.training_data import TrainingData, Message
from ner_tussie.utils import create_dir, write_json_to_file
...
class Metadata(object):
    ...
    def persist(self, model_dir):
        ...
        metadata.update({
            ...
            "rasa_nlu_version": ner_tussie.__version__,
        })
    ...
    def ensure_model_compatibility(metadata, version_to_check=None):
        ...
        if version.parse(model_version) < version.parse(version_to_check):
            raise UnsupportedModelError(
                ...
                "".format(model_version, ner_tussie.__version__))

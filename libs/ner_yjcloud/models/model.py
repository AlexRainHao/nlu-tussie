...
from ner_yjcloud.utils.bilstm_utils import result_to_json
from ner_yjcloud.utils.bilstm_utils import iobes_iob, iob_iobes
...
class Model(object):
    ...
    def __init__(self, config):
        ...
        self.lengths = tf.cast(length, tf.int32) # real length

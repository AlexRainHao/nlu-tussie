...
# PROLIBPATH = opt.abspath(opt.join(opt.abspath(__file__), *[opt.pardir] * 4))
...
from ner_yjcloud.models.flat_lattice.fastNLP_module import StaticEmbedding
from ner_yjcloud.models.flat_lattice.V0.utils_ import Trie, get_skip_path
from ner_yjcloud.models.flat_lattice.utils import get_bigrams

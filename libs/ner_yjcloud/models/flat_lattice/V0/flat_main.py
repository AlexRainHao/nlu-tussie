...
from ner_yjcloud.utils import set_module

from load_data import *
from paths import *

from V0.models import Lattice_Transformer_SeqLabel, Transformer_SeqLabel
from utils import get_peking_time, norm_static_embedding, print_info
...
# device = [torch.device('cuda:{%d}' % i) for i in range(2)]

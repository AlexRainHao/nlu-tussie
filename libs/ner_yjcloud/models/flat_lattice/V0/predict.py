...
from ner_yjcloud.models.flat_lattice.utils import get_bigrams, norm_static_embedding
from ner_yjcloud.models.flat_lattice.load_data import *
from ner_yjcloud.models.flat_lattice.V0.add_lattice import equip_chinese_ner_with_lexicon
from ner_yjcloud.models.flat_lattice.V0.utils_ import Trie
...
def load_vocab(model_dir, cache_dir, norm_embed = True, norm_lattic_embed = True):
    ...
    # resume_ner_path = "/home/user/yuanyh/Flat_Lattice_NER.bak/data/resume/toy"
    # raw_dataset_cache_name = "/home/user/yuanyh/Flat_Lattice_NER.bak/cache/resume_trainClip:Truebgminfreq_1char_min_freq_1word_min_freq_1only_train_min_freqTruenumber_norm0load_dataset_seed100"
    # yangjie_rich_pretrain_unigram_path = '/home/user/yuanyh/Flat_Lattice_NER.bak/pretrainedModel/gigaword_chn.all.a2b.uni.ite50.vec'
    # yangjie_rich_pretrain_bigram_path = '/home/user/yuanyh/Flat_Lattice_NER.bak/pretrainedModel/gigaword_chn.all.a2b.bi.ite50.vec'
    # yangjie_rich_pretrain_word_path = '/home/user/yuanyh/Flat_Lattice_NER.bak/pretrainedModel/ctb.50d.vec'
    #

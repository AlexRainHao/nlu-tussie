...
from ner_yjcloud.tokenizers import Tokenizer, Token, SegPos
from ner_yjcloud.training_data import Message, TrainingData
...
class JiebaTokenizer(Tokenizer, Component):
    ...
    def tokenize(self, text):
        ...
        pos_tokenized = psg.lcut(text)


        tokens = [Token(word, start) for (word, start, end) in tokenized]
        pos = SegPos(pos_tokenized)
        return tokens, pos

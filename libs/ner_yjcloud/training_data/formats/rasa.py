...
from ner_yjcloud.training_data.formats.readerwriter import (
    JsonTrainingDataReader,
    TrainingDataWriter)
from ner_yjcloud.training_data.util import transform_entity_synonyms
    ...
    def dumps(self, training_data, **kwargs):
        ...
        return json_to_string({
            "rasa_nlu_data": {
                ...
                "regex_intent": training_data.regex_intent
            }
        }, **kwargs)

...
import ner_yjcloud
from ner_yjcloud import components, utils, config
from ner_yjcloud.components import Component, ComponentBuilder
from ner_yjcloud.config import RasaNLUModelConfig, override_defaults
from ner_yjcloud.persistor import Persistor
from ner_yjcloud.training_data import TrainingData, Message
from ner_yjcloud.utils import create_dir, write_json_to_file
...
class Metadata(object):
    ...
    def persist(self, model_dir):
        ...
        metadata.update({
            ...
            "rasa_nlu_version": ner_yjcloud.__version__,
        })
    ...
    def ensure_model_compatibility(metadata, version_to_check=None):
        ...
        if version.parse(model_version) < version.parse(version_to_check):
            raise UnsupportedModelError(
                ...
                "".format(model_version, ner_yjcloud.__version__))

...
from ner_yjcloud.extractors import PostProcessor
from ner_yjcloud import utils, config
from ner_yjcloud.config import RasaNLUModelConfig
from ner_yjcloud.data_router import (
    DataRouter, InvalidProjectError,
    MaxTrainingError)
from ner_yjcloud.train import TrainingException
from ner_yjcloud.utils import json_to_string
from ner_yjcloud.version import __version__
from ner_yjcloud.model import MINIMUM_COMPATIBLE_VERSION
...
def create_argument_parser():
    ...
    parser.add_argument('--pre_load',
                        ...
                        help='Preload models into memory before starting the '
                             ...
                             'ner_yjcloud.server --pre_load project1 --path projects '
                             '-c config.yaml')
